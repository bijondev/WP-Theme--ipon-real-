<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            //     'desc'     => __( '', 'redux-framework-demo' ),
            //     'default'  => array(
            //             'url'=> dirname( __FILE__ ).'img/logo.png'
            //         ),
            // ),
            array(
                'id'       => 'logo',
                ...
                'default'  => array( 'url' => 'http://localhost/thinkersbd/wp-content/themes/ipon-real/img/logo.png' ),
                //'hint'      => array(
                //    'title'     => 'Hint Title',
            ...
            array(
                'id'       => 'apartments',
                'type'     => 'text',
                'title'    => __( 'Sales of apartments', 'redux-framework-demo' ),
                'subtitle' => __( '', 'redux-framework-demo' ),
                'desc'     => __( '', 'redux-framework-demo' )
            ),
            array(
